...
cat << 'EOF' > /tmp/ToscanoAltaUser-Groups.sh
#!/bin/bash
...
sudo mv /tmp/ToscanoAltaUser-Groups.sh /usr/local/bin/ToscanoAltaUser-Groups.sh
sudo chmod 755 /usr/local/bin/ToscanoAltaUser-Groups.sh
